...
function ConductaContent() {
  ...
  const showContent = !shouldShowSelectors || selectedStudentId;
  ...
  return (
    <div className="space-y-6">
      <div className="page-header">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="page-subtitle">Registro disciplinario</p>
          </div>
          <div className="flex items-center gap-2">
            {showContent && canCreate && !showForm && !editingSanction && selectedStudent && (
      ...
      {shouldShowSelectors && !selectedStudentId && selectedCourseId && students.length > 0 && (
        <div className="sacred-card text-center py-8">
          <p className="text-sm font-medium text-text-primary">Selecciona un estudiante</p>
          <p className="text-sm text-text-secondary mt-1">
            Elige un estudiante del selector para ver su conducta
          </p>
        </div>
      )}

      {shouldShowSelectors && !selectedCourseId && (
        <div className="sacred-card text-center py-8">
