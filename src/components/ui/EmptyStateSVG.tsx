  ...
  return (
    ...
    >
      ...
      <rect
        ...
        fill="#f2f8f4"
      />
      <rect width="643.86163" height="27.3536" fill="#2d5a45" />
      <circle cx="20.327" cy="13.98461" r="5.06978" fill="#f2f8f4" />
      <circle cx="39.57061" cy="13.98461" r="5.06978" fill="#f2f8f4" />
      <circle cx="58.81422" cy="13.98461" r="5.06978" fill="#f2f8f4" />
      <rect
        x="73.84385"
        y="86.97284"
        width="155.98055"
      ...
      <circle cx="537.09466" cy="190.79701" r="24.56103" fill="#f2b7a9" />
...
export function EmptyState({ 
  ...
  return (
    <div className={`flex flex-col items-center justify-center py-16 px-4 text-center ${className}`}>
      <div className="mb-6">
        {icon || <EmptyStateSVG className="w-24 h-24 text-muted-foreground" />}
      </div>
